...
public class JwtUtil {
    ...
    public  static  final String TOKENKEY =  "cpms7ba08e055b00626ac575e2dbee3cabb1"; //token密钥
    ...
    public static String createJWT(long ttlMillis, User user) {
        ...
        //生成签发人
        String subject = "cpms admin";

        System.out.println("生成jwt中..");
    ...
    public static Claims parseJWT(String token) {
        ...
        return claims; // {sub=cpms admin, id=1, exp=1568193688, iat=1568190088, jti=d39a766a-459a-4930-8aa8-3ef53b42118f, username=admin} 可以通过get()获取值
    }
}
